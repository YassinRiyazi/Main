...
#     plt.ylim(-30,200)
#     plt.savefig(save_address.replace('.tiff','.png'))
...
def visualize(save_address , i_list,j_list,i_left,j_left,i_right,j_right,
    ...
    ax.text(i_poly_left[0], j_poly_left[0] - 12, 'Advancing=' + str(round(adv, 2)), color="blue", fontsize=font_size)
    ...
    ax.text(i_poly_right[0] - 65, j_poly_right[0] - 12, 'Receding=' + str(round(rec, 2)), color="blue", fontsize=font_size)
