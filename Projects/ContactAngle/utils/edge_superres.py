...
class initiation():
    ...
    def initiate_torch(self,):
        ...
        self.sup_res_model.load_state_dict(torch.load("models/converted_model.pt", weights_only=True))#os.path.join(script_dir, "converted_model.pt")
...
def upscale_image(model, img):
    ...
    out_img_y = model.forward(input_tensor)
    ...
    # # Free memory
    # del input_tensor, input_tensor_tf, out
    # # gc.collect()
