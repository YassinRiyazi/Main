...
def visualize_edge_extraction(i_list, j_list, simple=False,
    ...
    if simple:
        ...
        for thr in thresholds:
            ...
            # Save and show
            plt.tight_layout()
            save_path = os.path.join(os.path.dirname(os.path.abspath(__file__)),f"edge_extraction_thr_{thr}.png")
...
if __name__ == "__main__":
    ...
    sys.path.append(os.path.abspath(os.path.join(os.path.dirname(__file__))))
    from superResolution import initiation,upscale_image
    fFuncname = advancing_pixel_selection
    ...
    for left_number_of_pixels in [10,30,60,90,120,150]:
        i_left, j_left              = fFuncname(i_list,j_list, left_number_of_pixels=left_number_of_pixels)
        ...
        plt.axis('off')
        plt.tight_layout()
        save_path = os.path.join(os.path.dirname(os.path.abspath(__file__)),f"{fFuncname.__name__}_advacingPoints{left_number_of_pixels}.png")
